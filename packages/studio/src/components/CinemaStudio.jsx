          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full pt-4 animate-fade-in-up">
            {history.map((entry, idx) => (
              <div
                ...
                className="relative group rounded-lg overflow-hidden border border-white/10 bg-[#0a0a0a] shadow-xl hover:border-blue-500/50 transition-all duration-300 flex flex-col cursor-pointer"
              ...
              >
                ...
                <div className="p-3 bg-black/80 backdrop-blur-sm border-t border-white/5 flex-1 flex flex-col justify-between gap-2">
                  ...
                  <div className="flex items-center justify-between mt-1 flex-wrap gap-1">
                    <span className="text-[10px] font-bold text-blue-400 px-2 py-0.5 bg-blue-600/10 rounded border border-blue-500/20">
          ...
          <div className="flex-1 flex flex-col gap-3 min-h-[80px] justify-between py-1">
            ...
            <div className="flex justify-between gap-2">
              ...
              <div className="flex items-center gap-3 h-full self-end mb-1">
                ...
                >
                  <div className="absolute top-3 right-3 w-1.5 h-1.5 bg-blue-600 rounded-full shadow-lg shadow-blue-600/20" />
                  ...
                  <span className="text-xs font-semibold text-white/70 truncate w-full group-hover:text-blue-400 transition-colors">
                    {formatSummaryValue()}
                  </span>
                </button>
                ...
                {/* Generate Button */}
                <button
                  className="h-[50px] px-8 bg-blue-600 text-white rounded-md font-medium text-sm hover:bg-blue-700 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-600/10 disabled:opacity-50 disabled:cursor-not-allowed"
