# ApexStudios by ApexDevLabs — Open-Source AI Image & Video Studio

> **The free, open-source creative AI studio by ApexDevLabs.** Generate AI images and videos using 200+ state-of-the-art models — no content filters, no closed ecosystem, no subscription fees.

**Repo:** [https://github.com/Apexdev250/ApexStudios](https://github.com/Apexdev250/ApexStudios) | **Community:** Join [Discord](https://discord.gg/sqFYv8ugND) for discussions and support
...
**Hosted version:** [https://dev.muapi.ai/apexstudios](https://dev.muapi.ai/apexstudios)
...
| Platform | Download |
|---|---|
| macOS Apple Silicon (M1/M2/M3/M4) | [ApexStudios-1.0.9-arm64.dmg](https://github.com/Apexdev250/ApexStudios/releases/download/v1.0.9/ApexStudios-1.0.9-arm64.dmg) |
| macOS Intel (x64) | [ApexStudios-1.0.9.dmg](https://github.com/Apexdev250/ApexStudios/releases/download/v1.0.9/ApexStudios-1.0.9.dmg) |
| Windows (x64) | [ApexStudios Setup 1.0.9.exe](https://github.com/Apexdev250/ApexStudios/releases/download/v1.0.9/ApexStudios.Setup.1.0.9.exe) |
| Linux (Ubuntu x64) | [v1.0.9 release](https://github.com/Apexdev250/ApexStudios/releases/tag/v1.0.9) (`.AppImage` / `.deb`), or build locally with `npm run electron:build:linux`. |

All releases: [github.com/Apexdev250/ApexStudios/releases](https://github.com/Apexdev250/ApexStudios/releases)
...
```bash
xattr -cr "/Applications/ApexStudios.app"
```
...
3. Scroll down to find _"ApexStudios was blocked"_
...
- **AppImage** — portable, run directly after making executable:
  ```bash
   chmod +x "release/ApexStudios-*.AppImage"
  ./release/Open\ Generative\ AI-*.AppImage
  ```
- **.deb** — install on Debian/Ubuntu:
  ```bash
  sudo apt install ./release/apexstudios_*_amd64.deb
  ```
...
APP_DATA="$HOME/Library/Application Support/apexstudios/local-ai"
...
> **Most users want the desktop app, not this dev path.** If you just want to run ApexStudios on your machine, [download a prebuilt installer](#-download-desktop-app) instead — no Node.js required. The instructions below are for contributors building from source.
...
git clone --recurse-submodules https://github.com/Apexdev250/ApexStudios.git
cd ApexStudios
...
Installers are output to the `release/` folder. Pre-built binaries are also available on the [Releases page](https://github.com/Apexdev250/ApexStudios/releases).
...
**ApexStudios by ApexDevLabs** is a community-driven, open-source alternative that provides similar creative capabilities without the closed ecosystem:

| | Other providers | ApexStudios |
| :--- | :--- | :--- |
...
| **Hosted version** | Subscription | Free at [muapi.ai/apexstudios](https://muapi.ai/apexstudios) |
| **Self-hosting** | No | Yes |
...
---
*Looking for a free, uncensored Higgsfield AI, Freepik, Krea, Openart AI alternative? ApexStudios is an open-source, unrestricted AI image and video generation studio — a Higgsfield AI, Freepik, Krea, Openart AI replacement with no content filters that you can self-host, customize, and extend.
